print("\nhttps://github.com/nkmk/python-snippets/blob/f37f46bc869139a9312b1491a62dec49fa600393/notebook/pprint_example.py#L1-L5\n")
...
print("\nLin 11 - pprint.pprint(l, width=200) :")
...
print("\nLin 11 - pprint.pprint(l, width=1) :")
